...
func (in *ProfileParameters) DeepCopyInto(out *ProfileParameters) {
	*out = *in
	if in.AllowedRepos != nil {
		in, out := &in.AllowedRepos, &out.AllowedRepos
	...
	if in.ForbidHTTPIngress != nil {
		in, out := &in.ForbidHTTPIngress, &out.ForbidHTTPIngress
		*out = new(bool)
		**out = **in
	}
	if in.ForbidNodePort != nil {
		in, out := &in.ForbidNodePort, &out.ForbidNodePort
		*out = new(bool)
		**out = **in
	}
	if in.ForbiddenTags != nil {
		in, out := &in.ForbiddenTags, &out.ForbiddenTags
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.RequireProbe != nil {
		in, out := &in.RequireProbe, &out.RequireProbe
		*out = new(bool)
		**out = **in
	}
	if in.UniqueIngress != nil {
		in, out := &in.UniqueIngress, &out.UniqueIngress
		*out = new(bool)
		**out = **in
	}
	if in.UniqueServiceSelector != nil {
		in, out := &in.UniqueServiceSelector, &out.UniqueServiceSelector
		*out = new(bool)
		**out = **in
	}
}
