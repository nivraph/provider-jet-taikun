...
func (mg *BillingRuleAttachment) GetTerraformResourceType() string {
	return "taikun_organization_billing_rule_attachment"
}
...
// LateInitialize this BillingRuleAttachment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *BillingRuleAttachment) LateInitialize(attrs []byte) (bool, error) {
	params := &BillingRuleAttachmentParameters{}
