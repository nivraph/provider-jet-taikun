...
// LateInitialize this Kubeconfig using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Kubeconfig) LateInitialize(attrs []byte) (bool, error) {
	params := &KubeconfigParameters{}
