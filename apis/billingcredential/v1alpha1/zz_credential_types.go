...
type CredentialParameters struct {
	...
	// Indicates whether to lock the billing credential. Defaults to `false`.
	// +kubebuilder:validation:Optional
	Lock *bool `json:"lock,omitempty" tf:"lock,omitempty"`

	// The name of the billing credential.
	// +kubebuilder:validation:Required
	Name *string `json:"name" tf:"name,omitempty"`

	// The ID of the organization which owns the billing credential.
	...
	// +kubebuilder:validation:Required
	PrometheusPasswordSecretRef v1.SecretKeySelector `json:"prometheusPasswordSecretRef" tf:"-"`

	// The Prometheus URL.
	// +kubebuilder:validation:Required
	PrometheusURL *string `json:"prometheusUrl" tf:"prometheus_url,omitempty"`

	// The Prometheus username.
	// +kubebuilder:validation:Required
	PrometheusUsername *string `json:"prometheusUsername" tf:"prometheus_username,omitempty"`
}
