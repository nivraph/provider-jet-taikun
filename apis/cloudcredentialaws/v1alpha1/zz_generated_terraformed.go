...
func (mg *CredentialAws) GetTerraformResourceType() string {
	return "taikun_cloud_credential_aws"
}

// GetConnectionDetailsMapping for this CredentialAws
func (tr *CredentialAws) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"access_key_id": "spec.forProvider.accessKeyIdSecretRef", "secret_access_key": "spec.forProvider.secretAccessKeySecretRef"}
}
...
// LateInitialize this CredentialAws using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CredentialAws) LateInitialize(attrs []byte) (bool, error) {
	params := &CredentialAwsParameters{}
