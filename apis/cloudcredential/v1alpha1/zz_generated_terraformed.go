...
func (mg *Credential) GetTerraformResourceType() string {
	return "taikun_cloud_credential"
}

// GetConnectionDetailsMapping for this Credential
func (tr *Credential) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"access_key_id": "spec.forProvider.accessKeyIdSecretRef", "client_id": "spec.forProvider.clientIdSecretRef", "client_secret": "spec.forProvider.clientSecretSecretRef", "password": "spec.forProvider.passwordSecretRef", "secret_access_key": "spec.forProvider.secretAccessKeySecretRef"}
}
