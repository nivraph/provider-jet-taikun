...
func (mg *CredentialGCP) GetTerraformResourceType() string {
	return "taikun_cloud_credential_gcp"
}
...
func (tr *CredentialGCP) GetObservation() (map[string]interface{}, error) {
...
func (tr *CredentialGCP) SetObservation(obs map[string]interface{}) error {
...
func (tr *CredentialGCP) GetParameters() (map[string]interface{}, error) {
...
func (tr *CredentialGCP) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this CredentialGCP using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CredentialGCP) LateInitialize(attrs []byte) (bool, error) {
	params := &CredentialGCPParameters{}
